...
export class LLamaClient {
    ...
    createChatCompletion = (
        ...
        const prompt = `A dialog, where User interacts with AI assistant. AI assistant is helpful, kind, obedient, honest, and knows its own limits. AI assistant can do programming tasks and return codes.
